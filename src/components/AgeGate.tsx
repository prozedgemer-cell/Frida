  ...
  return (
    <div className="age-gate">
      <div className="age-gate__card">
        ...
        <h1>Frida Diary</h1>
        <p>
          This is a private adult diary & roleplay space with sexual content.
          You must be at least <strong>18 years old</strong> to continue.
        </p>
        <p className="muted">
          Content is fictional roleplay. Hard limits and your own consent always apply.
        </p>
